...
class SavingSubScreen extends StatefulWidget {
  final String type;
  final TransactionType transactionType;
  final VoidCallback onBack;

  const SavingSubScreen({
    super.key,
  ...
  @override
  State<SavingSubScreen> createState() => _SavingSubScreenState();
}

class _SavingSubScreenState extends State<SavingSubScreen> {
